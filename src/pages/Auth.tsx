...
export default function Auth() {
  ...
  return (
    <>
      <Helmet>
        <title>Login | Assas Pay by Thoth - Integração Bitrix24 + Asaas</title>
        <meta name="description" content="Acesse sua conta Assas Pay by Thoth para gerenciar integrações de pagamento entre Bitrix24 e Asaas." />
      </Helmet>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 p-4">
        <Link to="/" className="flex items-center gap-2 mb-8">
          ...
          <span className="text-2xl font-bold text-foreground">Assas Pay by Thoth</span>
        </Link>
